...
- [ ] Chapter 9: Stacks and Queues
    ...
    - [ ] [ Evaluate RPN expressions ]( /solutions/evaluate\_rpn.py )
    - [ ] [ Test a string over for well-formedness ]( /solutions/is\_valid\_parenthesization.py )
...
- [ ] Chapter 10: Binary Trees
    - [ ] [ Test if a binary tree is height-balanced ]( /solutions/is\_tree\_balanced.py )
    ...
    - [ ] [ Implement an inorder traversal without recursion ]( /solutions/tree\_inorder.py )
    - [ ] [ Implement a preorder traversal without recursion ]( /solutions/tree\_preorder.py )
    ...
    - [ ] [ Reconstruct a binary tree from traversal data ]( /solutions/tree\_from\_preorder\_inorder.py )
...
- [ ] Chapter 15: Binary Search Trees
    - [ ] [ Test if a binary tree satisfies the BST property ]( /solutions/is\_tree\_a\_bst.py )
    - [ ] [ Find the first key greater than a given value in a BST ]( /solutions/search\_first\_greater\_value\_in\_bst.py )
    ...
    - [ ] [ Build a minimum height BST from a sorted array ]( /solutions/bst\_from\_sorted\_array.py )
